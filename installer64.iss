...
AppVerName=クロスワード ギバー (64ビット版) ver.3.9
AppPublisher=片山博文MZ
...
OutputDir=.
OutputBaseFilename=xword64-3.9-setup
Compression=lzma
...
Source: "豚辞書（第１４版）.dic"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\豚辞書（第１４版）.dic"; Filename: "{app}\豚辞書（第１４版）.dic"
