...
#define MyAppVersion     GetStringFileInfo('XWordGiver64.exe',"FileVersion")
...
#define MyAppDescription "XWordGiver 64-bit"
...
OutputDir=.
OutputBaseFilename=XWordGiver-{#MyAppVersion}-x64-setup
Compression=lzma
