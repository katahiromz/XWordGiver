...
AppName=XWordGiver (x64)
AppVerName=XWordGiver (x64) ver.4.7.5
...
DefaultGroupName=XWordGiver (x64)
OutputDir=.
OutputBaseFilename=xword64-4.7.5-en-setup
Compression=lzma
...
Name: "{commondesktop}\XWordGiver (x64)"; Filename: "{app}\xword64.exe"; Tasks: desktopicon
...
[Run]
Filename: "{app}\xword64.exe"; Description: "{cm:LaunchProgram,XWordGiver}"; Flags: nowait postinstall skipifsilent
