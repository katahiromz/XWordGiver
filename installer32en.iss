...
AppName=XWordGiver (x86)
AppVerName=XWordGiver (x86) ver.4.7.5
...
DefaultGroupName=XWordGiver (x86)
OutputDir=.
OutputBaseFilename=xword32-4.7.5-en-setup
Compression=lzma
...
Source: "LICENSE-ENG.txt"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\XWordGiver (x86)"; Filename: "{app}\xword32.exe"
Name: "{group}\ReadMe.txt"; Filename: "{app}\ReadMe.txt"
Name: "{group}\TechNote.txt"; Filename: "{app}\TechNote.txt"
Name: "{group}\HISTORY.txt"; Filename: "{app}\HISTORY.txt"
Name: "{group}\Author's homepage"; Filename: "http://katahiromz.web.fc2.com/"
Name: "{group}\{cm:UninstallProgram,XWordGiver}"; Filename: "{uninstallexe}"
Name: "{group}\DICT"; Filename: "{app}\DICT"
Name: "{group}\BLOCK"; Filename: "{app}\BLOCK"
Name: "{group}\LICENSE-ENG.txt"; Filename: "{app}\LICENSE-ENG.txt"
Name: "{commondesktop}\XWordGiver (x86)"; Filename: "{app}\xword32.exe"; Tasks: desktopicon
...
Root: HKCR; Subkey: "XWordGiver.JsonFile"; ValueType: string; ValueName: ""; ValueData: "XWordGiver JSON data"; Flags: uninsdeletekey; Tasks: association
...
[Tasks] 
Name: association; Description: "Associate *.xwj files"

[Run]
Filename: "{app}\xword32.exe"; Description: "{cm:LaunchProgram,XWordGiver}"; Flags: nowait postinstall skipifsilent
